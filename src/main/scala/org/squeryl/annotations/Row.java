 ...
 *
 * @Row(fieldToColumnCorrespondanceMode=FieldToColumnCorrespondanceMode.IMPLICIT) which means that all fields and properties (pairs of setters and getters) will
